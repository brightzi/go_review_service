...
type ReviewClient interface {
	...
	GetReplyReview(ctx context.Context, in *GetReviewReplyRequest, opts ...grpc.CallOption) (*ReviewReplyInfo, error)
	// B端申诉评价
...
func (c *reviewClient) GetReplyReview(ctx context.Context, in *GetReviewReplyRequest, opts ...grpc.CallOption) (*ReviewReplyInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReviewReplyInfo)
	err := c.cc.Invoke(ctx, Review_GetReplyReview_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReviewServer) GetReplyReview(context.Context, *GetReviewReplyRequest) (*ReviewReplyInfo, error) {
...
func _Review_GetReplyReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).GetReplyReview(ctx, req.(*GetReviewReplyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
